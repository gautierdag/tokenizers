...
impl Word {
    ...
    pub(super) fn get_chars_iter(&self) -> impl Iterator<Item = u64> + '_ {
...
mod tests {
    ...
    fn test_merge_max_length() {
        ...
        assert_eq!(
            ...
            &[
                ((1u64, 2u64), -1i32), // count for ('e', 'l') should be decreased by 1.
                // ((1u64, 4u64), 1i32),  Missing since this would be larger than 2
                ((2u64, 3u64), -1i32), // count for ('l', 'o') should be decreased by 1.
                                       // ((4u64, 3u64), 1i32), Missing since this would be larger than 2
            ]
        );
    }
}
