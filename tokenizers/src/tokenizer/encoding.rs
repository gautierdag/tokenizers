...
impl Encoding {
    ...
    pub fn get_word_ids(&self) -> &[Option<u64>] {
        &self.words
    }

    pub fn get_word_ids_mut(&mut self) -> &mut [Option<u64>] {
        &mut self.words
    }
    ...
    pub fn set_type_ids(&mut self, type_ids: Vec<u64>) {
    ...
    pub fn word_to_tokens(&self, word: u64, sequence_id: usize) -> Option<(usize, usize)> {
    ...
    pub fn word_to_chars(&self, word: u64, sequence_id: usize) -> Option<Offsets> {
    ...
    pub fn token_to_word(&self, token: usize) -> Option<(usize, u64)> {
        Some((
            self.token_to_sequence(token)?,
    ...
    pub fn char_to_word(&self, pos: usize, sequence_id: usize) -> Option<u64> {
        Some(
